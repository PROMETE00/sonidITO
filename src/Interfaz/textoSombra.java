...
public class textoSombra extends JLabel implements FocusListener, DocumentListener {
    ...
    public textoSombra(String text, JTextComponent component) {
        this(text, component, Show.ALWAYS);
    }

    public textoSombra(String text, JTextComponent component, Show show) {
